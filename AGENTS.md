...
- Always install a browser when setting up this repository: run `npm ci` followed by `npx playwright-cli install --skills=agents`. This installs the browser and refreshes the bundled agent skill.
